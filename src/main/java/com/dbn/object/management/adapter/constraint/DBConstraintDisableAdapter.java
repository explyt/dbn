...
/**
 * Implementation of the {@link com.dbn.object.management.ObjectManagementAdapter} specialized in disabling entities of type {@link DBConstraint}
 *
 * @author Dan Cioca (Oracle)
 */
public class DBConstraintDisableAdapter extends DBObjectDisableAdapter<DBConstraint> {

    public DBConstraintDisableAdapter(DBConstraint object) {
        super(object);
    }
