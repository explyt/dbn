 ...
 */
public abstract class DBObjectCreateAdapter<T extends DBObject> extends ObjectManagementAdapterBase<T> {

    public DBObjectCreateAdapter(T object) {
        super(object, ObjectChangeAction.CREATE);
    }
