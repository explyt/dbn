...
/**
 * Implementation of the {@link com.dbn.object.management.ObjectManagementAdapter} specialized in enabling entities of type {@link DBConstraint}
 *
 * @author Dan Cioca (Oracle)
 */
public class DBConstraintEnableAdapter extends DBObjectEnableAdapter<DBConstraint> {

    public DBConstraintEnableAdapter(DBConstraint object) {
        super(object);
    }
