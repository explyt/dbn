...
public interface DatabaseDataDefinitionInterface extends DatabaseInterface{
    ...
    *********************************************************/
    ...
    default void dropJavaObject(String ownerName, String objectName, boolean isSourceAvailable, boolean isBinaryAvailable, DBNConnection connection) throws SQLException {}
   /*********************************************************
    *                   RENAME statements                     *
    *********************************************************/
